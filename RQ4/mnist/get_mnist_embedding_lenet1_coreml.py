...
def run_node2vec():
    save_embedding = 'mnist_lenet1_coreml_node2vec.pkl'
    tree_path = 'mnist_lenet1_coreml_tree.txt'
...
def run_line():
    save_embedding = 'mnist_lenet1_coreml_line.pkl'
    tree_path = 'mnist_lenet1_coreml_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_deepwalk():
    save_embedding = 'mnist_lenet1_coreml_deepwalk.pkl'
    tree_path = 'mnist_lenet1_coreml_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_struc2vec():
    save_embedding = 'mnist_lenet1_coreml_struc2vec.pkl'
    tree_path = 'mnist_lenet1_coreml_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
