...
x_train, x_train_prediction, y_train = get_X_ypre(path_pre_data_lenet1_tflite_train, 'y_train.pkl')
x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_lenet1_tflite_test, 'y_test.pkl')
