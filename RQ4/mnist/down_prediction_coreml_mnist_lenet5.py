...
path_tree_model = 'mnist_lenet5_coreml_tree.model'
select_model = 'mnist_lenet5_coreml_enhance_model_60.mlmodel'
path_graph_model = 'mnist_lenet5_coreml_node2vec.pkl'
