...
path_tree_model = 'mnist_lenet5_tflite_tree.model'
select_model = 'mnist_lenet5_tflite_enhance_model_60.tflite'
path_graph_model = 'mnist_lenet5_tflite_node2vec.pkl'
