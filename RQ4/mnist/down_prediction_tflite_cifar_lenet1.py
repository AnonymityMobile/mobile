...
path_tree_model = 'mnist_lenet1_tflite_tree.model'
select_model = 'mnist_lenet1_tflite_enhance_model_60.tflite'
path_graph_model = 'mnist_lenet1_tflite_node2vec.pkl'
...
def model_prediction(x_prediction, x_statistic_feature, x_graph_vec, x_pic):
    ...
    for i in range(len(x_prediction)):
        ...
        x3 = get_shape_1_28_28_1(x_pic[i])
