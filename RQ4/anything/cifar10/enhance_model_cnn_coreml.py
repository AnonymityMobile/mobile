...
# python enhance_model_cnn_tflite.py -s 'cifar10_cnn_tflite' -t 'cifar10_cnn_tflite_tree.model' -g 'cifar10_cnn_tflite_node2vec.pkl'

# save_flag = 'cifar10_cnn_tflite'
# path_tree_model = 'cifar10_cnn_tflite_tree.model'
# path_graph_model = 'cifar10_cnn_tflite_node2vec.pkl'

x_train, x_train_prediction, y_train = get_X_ypre(path_pre_data_cnn_coreml_train, 'y_train.pkl')
x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_cnn_coreml_test, 'y_test.pkl')
