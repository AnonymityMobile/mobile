...
def get_X_ypre(config_path_list, path_y):
    ...
    tmp_ypre_train = np.array(pickle.load(open(tinyimagenet_resnet_prediction_train_coreml, 'rb')))
    tmp_ypre_test = np.array(pickle.load(open(tinyimagenet_resnet_prediction_test_coreml, 'rb')))
...
save_flag = 'tinyimagenet_resnet_coreml'
path_tree_model = 'tinyimagenet_resnet_coreml.model'
path_graph_model = 'tinyimagenet_resnet_coreml_node2vec.pkl'

x_train, x_train_prediction, y_train, x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_resnet_coreml_data, tiny_imagenet_label)
