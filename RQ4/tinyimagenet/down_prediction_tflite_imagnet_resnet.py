...
path_tree_model = 'tinyimagenet_resnet_tflite.model'
select_model = 'tinyimagenet_resnet_tflite_enhance_model_60.tflite'
path_graph_model = 'tinyimagenet_resnet_tflite_node2vec.pkl'
