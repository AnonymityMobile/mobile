...
def run_node2vec():
    save_embedding = 'tinyimagenet_resnet_tflite_node2vec.pkl'
    tree_path = 'tinyimagenet_resnet_tflite.txt'
...
def run_line():
    save_embedding = 'tinyimagenet_resnet_tflite_line.pkl'
    tree_path = 'tinyimagenet_resnet_tflite.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_deepwalk():
    save_embedding = 'tinyimagenet_resnet_tflite_deepwalk.pkl'
    tree_path = 'tinyimagenet_resnet_tflite.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_struc2vec():
    save_embedding = 'tinyimagenet_resnet_tflite_struc2vec.pkl'
    tree_path = 'tinyimagenet_resnet_tflite.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
