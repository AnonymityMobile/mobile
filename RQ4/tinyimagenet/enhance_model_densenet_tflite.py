...
save_flag = 'tinyimagenet_densenet_tflite'
path_tree_model = 'tinyimagenet_densenet_tflite.model'
path_graph_model = 'tinyimagenet_densenet_tflite_node2vec.pkl'

x_train, x_train_prediction, y_train, x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_densenet_tflite_data, tiny_imagenet_label)
