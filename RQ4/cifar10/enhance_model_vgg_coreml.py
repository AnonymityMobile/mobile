...
x_train, x_train_prediction, y_train = get_X_ypre(path_pre_data_vgg_coreml_train, 'y_train.pkl')
x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_vgg_coreml_test, 'y_test.pkl')
