...
import pickle
from RQ4.GraphEmbedding.ge.models import Node2Vec
from RQ4.GraphEmbedding.ge.models import DeepWalk
from RQ4.GraphEmbedding.ge.models.line import LINE
from RQ4.GraphEmbedding.ge.models.struc2vec import Struc2Vec


def run_node2vec():
    save_embedding = 'cifar10_vgg_tflite_node2vec.pkl'
    tree_path = 'cifar10_vgg_tflite_tree.txt'
...
def run_line():
    save_embedding = 'cifar10_vgg_tflite_line.pkl'
    tree_path = 'cifar10_vgg_tflite_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_deepwalk():
    save_embedding = 'cifar10_vgg_tflite_deepwalk.pkl'
    tree_path = 'cifar10_vgg_tflite_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_struc2vec():
    save_embedding = 'cifar10_vgg_tflite_struc2vec.pkl'
    tree_path = 'cifar10_vgg_tflite_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
