...
path_tree_model = 'cifar10_vgg_tflite_tree.model'
select_model = 'cifar10_vgg_tflite_enhance_model_60.tflite'
path_graph_model = 'cifar10_vgg_tflite_node2vec.pkl'
...
# python down_prediction_tflite_cifar_lenet1.py -p x_test.pkl -s enhancement_cnn_prediction_x_test_cnn.pkl -d prediction_x_test_cnn_tflite.pkl
