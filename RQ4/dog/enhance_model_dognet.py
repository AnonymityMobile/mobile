...
save_flag = 'dog'
path_tree_model = 'dognet_tree.model'
path_graph_model = 'dognet_node2vec.pkl'

x_train, x_train_prediction, y_train, x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_dognet, 'dog_image_label.pkl')
