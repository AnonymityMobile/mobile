...
def run_node2vec():
    save_embedding = 'dognet_node2vec.pkl'
    tree_path = 'dognet_tree.txt'
...
def run_line():
    save_embedding = 'dognet_line.pkl'
    tree_path = 'dognet_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_deepwalk():
    save_embedding = 'dognet_deepwalk.pkl'
    tree_path = 'dognet_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
...
def run_struc2vec():
    save_embedding = 'dognet_struc2vec.pkl'
    tree_path = 'dognet_tree.txt'
    G = nx.read_edgelist(tree_path, create_using=nx.DiGraph(), nodetype=None, data=[('weight', int)])
