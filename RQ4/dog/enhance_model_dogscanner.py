...
save_flag = 'dogscanner'
path_tree_model = 'dogscanner_tree.model'
path_graph_model = 'dogscanner_node2vec.pkl'

x_train, x_train_prediction, y_train, x_test, x_test_prediction, y_test = get_X_ypre(path_pre_data_dogscanner, 'dog_image_label.pkl')
