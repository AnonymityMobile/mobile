...
f = open('/Users/yinghua.li/Documents/Pycharm/data_mobile_model_testing/RQ1/prediction/mnist_lenet5_prediction_test.pkl', 'rb')
...
fig1.savefig('mnist_lenet5_tflite.pdf')
plt.show()
