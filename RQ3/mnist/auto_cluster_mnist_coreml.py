...
f = open('/Users/yinghua.li/Documents/Pycharm/data_mobile_model_testing/RQ1/prediction/mnist_lenet5_prediction_test_coreml.pkl', 'rb')
...
fig1.savefig('mnist_lenet5_coreml.pdf')
plt.show()
