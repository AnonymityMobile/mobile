...
f = open('anything_prediction_test.pkl', 'rb')
prediction_np = np.array(pickle.load(f))
prediction_np = prediction_np / 255

f = open('anything_image_data.pkl', 'rb')
X = pickle.load(f)
f = open('anything_image_label.pkl', 'rb')
y = pickle.load(f)
...
model_encoder = load_model('auto_encoder_anything.h5')
...
# fig1.savefig('../pictures/anything_tflite.pdf')
# plt.show()
