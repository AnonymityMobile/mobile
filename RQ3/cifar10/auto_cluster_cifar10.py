...
f = open('/Users/yinghua.li/Documents/Pycharm/data_mobile_model_testing/cifar10/prediction/cifar10_vgg_prediction_test.pkl', 'rb')
...
fig1.savefig('../pictures/cifar10_vgg_tflite.pdf')
plt.show()
