...
f = open('/Users/yinghua.li/Documents/Pycharm/data_mobile_model_testing/cifar10/prediction/cifar10_vgg_prediction_test_coreml.pkl', 'rb')
...
print(df.head())
print(accuracy_score(list(df['pre']), list(df['real'])))
...
fig1.savefig('../pictures/cifar10_vgg_coreml.pdf')
plt.show()
